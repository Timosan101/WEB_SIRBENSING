...
<body>
    ...
    <table class="data-table">
        ...
        <tbody>
            <?php if ($clients && $clients->num_rows > 0): ?>
                <?php 
                // CALCULATE DISPLAY COUNTER BASED ON TOTAL CLIENT ROWS
                $display_id = $clients->num_rows; 
                ?>
                <?php while ($client = $clients->fetch_assoc()): ?>
                    <tr>
                        <!-- DISPLAY SEQUENTIAL ROW ID (E.G., 1 INSTEAD OF DATABASE ID 6) -->
                        ...
                        <td>
                            <!-- VIEW ORDERS BUTTON (USES REAL DATABASE $client['id']) -->
                            ...
                            <!-- REMOVE CLIENT LINK (USES REAL DATABASE $client['id']) -->
    ...
    function openOrderModal(userId, clientName) {
        ...
        // FETCH CLIENT ORDERS FROM FETCH_CLIENT_ORDERS.PHP
